...
type
  ...
  TAdGraphicFormat = class(TAdPersistent)
    public
      ...
      {This function should be used to copy the alpha channel of the specified object into the TAdBitmap. If the specified object hasn't got an alphachannel, a RGB mixture value should be used.}
...
var
  ...
  {This stringlist contains the names of all registered graphic formats}
