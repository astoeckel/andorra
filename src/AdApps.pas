...
type
  ...
  strict private
    ...
    FPictureCollection: TPictureCollection;
  ...
  public
    ...
    property PictureCollection: TPictureCollection read FPictureCollection
      write FPictureCollection;
...
begin
  ...
  FPictureCollection := TPictureCollection.Create(FDraw);
