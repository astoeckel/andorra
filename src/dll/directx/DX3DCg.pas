...
type
  ...
  TDXCgShader = class(TAd2dShader)
    ...
    public
      ...
      procedure SetParameter(AParam: Pointer; AValue: single);overload;override;
      procedure SetParameter(AParam: Pointer; AValue: TAdMatrix);overload;override;
...
procedure TDXCgShader.SetParameter(AParam: Pointer; AValue: TAdMatrix);
begin
  cgD3D9SetUniformMatrix(AParam, PD3DMATRIX(@AValue)^);
end;

procedure TDXCgShader.SetParameter(AParam: Pointer; AValue: single);
begin
  cgSetParameterValuefr(AParam, 1, @AValue);
end;

procedure TDXCgShader.SetParameter(AParam: Pointer; AValue: TAndorraColor);
begin
  cgSetParameter4f(AParam,
    AValue.r / 255,
    AValue.g / 255,
    AValue.b / 255,
    AValue.a / 255);
...
procedure TDXCgShader.SetParameter(AParam: Pointer; AValue: PChar;
  ASize: Cardinal);
var
  buf: string;
begin
